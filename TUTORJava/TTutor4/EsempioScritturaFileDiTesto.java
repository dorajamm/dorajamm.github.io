...
public class EsempioScritturaFileDiTesto {
	public static void main(String[] args) {
		...
		try {
			//outputStream = new PrintWriter(nomeFile); // cancella eventualmente il file esistente
			outputStream = new PrintWriter(new FileOutputStream(nomeFile, true)); // aggiunge eventualmente ad un file esistente
